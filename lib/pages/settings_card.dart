...
class SettingsCard extends StatefulWidget {
  ...
  SettingsCard({Key? key, required this.tag, required this.fontsize_english, required this.fontsize_arab, required this.theme}) : super(key: key);
...
class _SettingsCardState extends State<SettingsCard> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    super.initState();
    widget.theme == Colors.white ? setState((){
                          ...
                          child: Column(
                            ...
                            children: [Row(
                              ...
                              AnimatedContainer(
                                ...
                                decoration: BoxDecoration(
                                  borderRadius: BorderRadius.circular(21),
                                  color: widget.theme == Colors.white ? Colors.white.withOpacity(.21) : Colors.black.withOpacity(.21)
                                ),
                                child: Padding(
                              ...
                              AnimatedContainer(
                                ...
                                curve: Curves.linearToEaseOut,
                                width: size.width,
                                height: shouldShowAboutCard ? size.height - (57 + appBar.preferredSize.height) : 0,
                              decoration: BoxDecoration(
                                color: widget.theme == Colors.white ? Colors.white : Colors.black,
                                borderRadius: BorderRadius.circular(21)
                              ),
                                child: SingleChildScrollView(
                                  child: Column(
                                    children: [
                                      Padding(
                                        padding: EdgeInsets.only(top: appBar.preferredSize.height ,bottom: 21.0),
                                        child: Stack(
                                          ...
                                          children: [
                                            RippleAnimation(
                                                ...
                                                ClipRRect(
                                                  borderRadius: BorderRadius.circular(1000),
                                                  child: Image.asset('lib/assets/images/dev picture.png',
                                                    width: size.width * .25,
                                        ...
                                        TextSpan(
                                          children: [
                                            ...
                                            const WidgetSpan(
                                                ...
                                                child: Icon(Icons.open_in_new, color: Colors.blue, size: 14,)),
                                            TextSpan(
                                              text: ' uchiha.sherimello@gmail.com',
                                              ...
                                              recognizer: TapGestureRecognizer()
                                                ..onTap = () async {
                                                  final url = Uri(scheme: 'mailto',
                                                    path: 'uchiha.sherimello@gmail.com',);
                                        ...
                                        child: Text.rich(
                                          TextSpan(
                                            ...
                                            children: const [
                                              ...
                                              TextSpan(
                                                text: "(long-term kindness that accrues ongoing reward from ALLAH (SWT)) ",
                                                style: TextStyle(
                                                  fontFamily:
                                                  'varela-round.regular',
                                                  fontWeight: FontWeight.bold
                                              ...
                                              TextSpan(
                                                text: "for everyone associated in the making of it.  we will make it opensource with the very first stable release (",
                                                style: TextStyle(
                                                  fontFamily:
                                                  'varela-round.regular',
                                                ),
                                              ...
                                              TextSpan(
                                                text: "). none of the users' personal data are stored in our servers without encryption. even we won't be able to decrypt those data. keep us in your prayers.\n"
                                              ),
                                            ]
                                          ),
                                          textAlign: TextAlign.center,
