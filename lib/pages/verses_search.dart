  ...
  Widget build(BuildContext context) {
    ...
    return Stack(
      children: [
        ...
        Center(child: Visibility(visible: true, child: Image.asset(load == 0 ? 'lib/assets/images/search.png' : 'lib/assets/images/loading.gif', width: size.width * .41, height: size.width * .41,))),
// hjkg
      ],
    );
  }
